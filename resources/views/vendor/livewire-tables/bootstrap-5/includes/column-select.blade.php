    ...
    <div class="mb-3 mb-md-0 md-0 ms-md-2">
        <div x-data="{ open: false }" x-on:keydown.escape.stop="open = false" x-on:mousedown.away="open = false"
            ...
            <button x-on:click="open = !open"
                class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto dropdown-toggle d-block w-100 d-md-inline"
                type="button" id="columnSelect" aria-haspopup="true" x-bind:aria-expanded="open">
                @lang('Columns')
            </button>

...
use App\Http\Livewire\Backoffice\Reports\RentedProducts;
...
Route::group(['middleware' => ['auth']], function () {
    Route::middleware(['account_confirmed'])->group(function () {
        ...
        Route::get('/backoffice/reports/rented-products', RentedProducts::class)->name('backoffice.reports.rented-products');
    });
